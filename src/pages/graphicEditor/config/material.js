  ...
  LineFlow: [
    {
      ...
      label: "图片",
      type: "label",
      defval: "src/assets/img/textures/fence.png",
    },
    { name: "color", label: "颜色", type: "color", defval: "#3388ff" },
  ...
  WaterLight: [
    {
      ...
      label: "反射图片",
      type: "label",
      defval: "src/assets/img/textures/poly-stone.jpg",
    },
    {
      name: "alpha",
      label: "透明度",
  ...
  CircleScan: [
    {
      ...
      label: "图片",
      type: "label",
      defval: "src/assets/img/textures/circle-scan.png",
    },
    { name: "color", label: "颜色", type: "color", defval: "#3388ff" },
  ],
  CircleWave: [
  ...
  dataAssociation: [
    {
      ...
      label: "事件类型",
      type: "combobox",
      data: transformData(window.info.eventType),
      defval: "",
    },
    {
      name: "maskColor",
