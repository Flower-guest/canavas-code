    ...
    style: [
      {
        ...
        show(style, allStyle, graphicType) {
          return (
            graphicType === "divLightPoint" ||
            graphicType === "divBoderLabel" ||
            graphicType === "divUpLabel"
          );
        },
      },
      {
      ...
      { name: "width", label: "线宽", type: "number", step: 1, defval: 4.0 },
      {
        ...
        data: [
          ...
          },
          {
            ...
            value: "LineFlow-2",
            defval: {
              image: "src/assets/img/textures/line-arrow-dovetail.png",
              repeat_x: 10,
            },
          },
          {
            ...
            value: "LineFlow-3",
            defval: {
              image: "src/assets/img/textures/line-arrow-right.png",
              repeat_x: 10,
            },
          },
          {
          ...
          },
          {
            ...
            value: "LineFlow-5",
            defval: {
              image: "src/assets/img/textures/line-color-azure.png",
              repeat_x: 10,
            },
          },
          {
            ...
            value: "LineFlow-6",
            defval: {
              image: "src/assets/img/textures/line-color-red.png",
              color: "#ff0000",
              repeat_x: 10,
            },
          },
          {
            ...
            value: "LineFlow-7",
            defval: {
              image: "src/assets/img/textures/line-color-yellow.png",
              color: "#ffff00",
              repeat_x: 10,
            },
          },
          ...
          },
          {
            label: "流动pulse",
            value: "LineFlow-10",
            defval: { image: "src/assets/img/textures/line-pulse.png" },
          },
          {
            label: "流动sprite",
            value: "LineFlow-11",
          ...
          },
          {
            label: "流动tarans",
            value: "LineFlow-13",
            defval: { image: "src/assets/img/textures/line-tarans.png" },
          },
          {
            label: "流动vertebral",
            value: "LineFlow-14",
          ...
          },
          {
            ...
            value: "LineFlow-15",
            defval: {
              image: "src/assets/img/textures/line-vertebral-blue.png",
              repeat_x: 10,
            },
          },
          {
          ...
          },
          {
            ...
            value: "LineFlow-17",
            defval: {
              image: "src/assets/img/textures/line-arrow-trans.png",
              repeat_x: 10,
            },
          },
        ],
      ...
      { name: "fill", label: "是否填充", type: "radio", defval: true },
      {
        ...
        data: [
          ...
          },
          {
            label: "流动fence",
            value: "LineFlow-2",
            defval: { image: "src/assets/img/textures/fence.png", axisY: true },
          },
          {
            label: "流动line",
            value: "LineFlow-3",
  ...
  water: {
    ...
    style: [
      ...
      },
      {
        ...
        label: "反射图片",
        type: "label",
        defval: "src/assets/img/textures/waterNormals.jpg",
      },
      {
        name: "frequency",
        label: "波数",
